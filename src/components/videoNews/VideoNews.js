                ...
                <div className="video__news">
                    ...
                    <div className="video__news-items">
                        <div className="video__news-item">
                            ...
                            <img src={video} alt="video" />
                            <div className="fz12 video__news-data">05 серпня 11:00</div>
                            <div className="fz16 video__news-content">Ватажок "ДНР" підтвердив підготовку самосуду над полоненими українськими військовими. Відео
                            </div>
                        </div>
                        <div className="video__news-item">
                            <button className='video__play'>
                            ...
                            <img src={video} alt="video" />
                            <div className="fz12 video__news-data">05 серпня 11:00</div>
                            <div className="fz16 video__news-content">Під москвою палала військова частина, де проходять службу строковики (відео)
                            </div>
                        </div>
                        <div className="video__news-item">
                            <button className='video__play'>
                            ...
                            <img src={video} alt="video" />
                            <div className="fz12 video__news-data">05 серпня 11:00</div>
                            <div className="fz16 video__news-content">"Спекотні літні канікули": Міноборони України попередило росіян про наслідки відвідування Криму (відео)</div>
                        </div>
                        <div className="video__news-item">
                            <button className='video__play'>
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <img src={video} alt="video" />
                            <div className="fz12 video__news-data">05 серпня 11:00</div>
                            <div className="fz16 video__news-content">СБУ затримала в Києві "військового експерта", який працював на росію (фото)
                            </div>
                        </div>
                    </div>
                </div>

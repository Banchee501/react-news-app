        ...
        const items = arr.map((item) => {
            return (
                <div className="video__news-item">
                    ...
                    <div className="fz12 video__news-data">{item.data}</div>
    ...
    return (
        <div className='container'>
            <div className="video">
                ...
                <div className="title_fz32 video__news-content">"Це не Джошуа": Усик розповів, кого вважає своїм головним суперником</div>
            </div>
                    </div>

            ...
            <div className="news">
                ...
                <div className="news__promo">
                    ...
                    <div className="news__promo-body">
                        <img src="../../resources/img/imageph.jpg" alt="image-promo" />
                        <div className="date label">05 СЕРПНЯ 11:00</div>
                        <div className="news__promo-text">Акція! Телевізори Samsung з вигодою та в оплату частинами до 12 платежів</div>
                    </div>
                ...
                <div className="news__economics">
                    ...
                    <div className="news__economics-blocks">
                        <div className="news__economics-block">
                            ...
                            <div className="date">05 СЕРПНЯ 11:00</div>
                            <div className="news__economics-text">У "Слузі" пояснили, чому в росії знову заговорили про переговори з Україною.</div>
                        </div>
                        <div className="news__economics-block">
                            <img src="../../resources/img/image.jpg" alt="image-news" />
                            <div className="date">05 СЕРПНЯ 11:00</div>
                        ...
                        <div className="news__economics-block">
                            <img src="../../resources/img/image.jpg" alt="image-news" />
                            <div className="date">05 СЕРПНЯ 11:00</div>
                            <div className="news__economics-text">ТРЦ Ocean Plaza після чуток про закриття оголосив про відновлення роботи</div>
                        </div>
                    </div>
                ...
                <div className="news__lifestyle">
                    ...
                    <div className="news__lifestyle-blocks">
                        <div className="news__lifestyle-block">
                            <img src="../../resources/img/imagenews.jpg" alt="image-news" />
                            <div className="date">05 СЕРПНЯ 11:00</div>
                            <div className="news__lifestyle-text">Селезньов розповів, навіщо росіяни спустошують склади боєприпасів у Білорусі</div>
                        </div>
                        <div className="news__lifestyle-block">
                            <img src="../../resources/img/image.jpg" alt="image-news" />
                            <div className="date">05 СЕРПНЯ 11:00</div>
                            <div className="news__lifestyle-text">У "Слузі" пояснили, чому в росії знову заговорили про переговори з Україною.</div>
                        </div>
                        <div className="news__lifestyle-block">
                            <img src="../../resources/img/image.jpg" alt="image-news" />
                            <div className="date">05 СЕРПНЯ 11:00</div>
                            <div className="news__lifestyle-text">ТРЦ Ocean Plaza після чуток про закриття оголосив про відновлення роботи</div>
                        </div>
                    </div>
